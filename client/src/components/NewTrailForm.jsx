...
import {Input, Button, Select, FormControl, Heading, FormLabel, Box, Text, Flex, FormHelperText} from '@chakra-ui/react'
...
function NewTrailForm({isLoggedIn}){
    ...
    return (
        <Box mt="60px" w="80%" ml="auto" mr="auto"> 
            <Heading mb="15px">Please Add a Trail!</Heading>
            ...
            <form id="new-trail-form" onSubmit={handleNewTrailSubmit}>
                ...
                <Flex flexWrap="inline">       
                    ...
                    <FormControl isRequired w="300px" ml="25px">
